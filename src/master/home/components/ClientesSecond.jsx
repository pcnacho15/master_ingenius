export const ClientesSecond = () => {
  return (
    <>
      <section
        id="clients"
        className="px-0 text-center bg-gray-200 dark:bg-neutral-950 transition-all ease-in-out duration-200"
      >
        <div className="">
          <div
          ...
          >
            <div className="flex justify-center items-center col-span-1 object-contain lg:col-span-1 ">
              <img
                ...
                alt="Cliente"
                className="max-w[45%] transition-all duration-400 ease-in-out inline-block px-0 filter grayscale
                hover:grayscale-0 hover:scale-150 max-w-20"
              />
            </div>
            <div className="flex justify-center items-center col-span-1 object-contain lg:col-span-1 ">
              <img
                ...
                alt="Cliente"
                className="max-w[45%] transition-all duration-400 ease-in-out inline-block px-0 grayscale
            ...
            <div className="flex justify-center items-center col-span-2 sm:col-span-1 object-contain lg:col-span-1 ">
              <img
                ...
                alt="Cliente"
                className="max-w[45%] transition-all duration-400 ease-in-out inline-block px-0 grayscale
                hover:grayscale-0 hover:scale-150 max-w-48"
              />
            </div>
          </div>
        </div>
